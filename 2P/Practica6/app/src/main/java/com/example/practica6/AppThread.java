...
public class AppThread extends Thread{
    ...
    public AppThread(SurfaceHolder surfaceHolder, Context context, Handler handler)
    {
        ...
        battCollection.add(resources.getDrawable(R.drawable.bat2));
        ...
        backgroundImage = BitmapFactory.decodeResource(resources, R.drawable.bac4);
    ...
    public AppThread(SurfaceHolder surfaceHolder) {
        this.surfaceHolder = surfaceHolder;
    }
    ...
    private void FinishGame()
    {
        ...
        AddToastToQueue("Selecciona un tipo de juego");
        ResetGame();
    }
