...
public class Unidad_2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Calculadora.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        Practica_Unidad2 p2 = new Practica_Unidad2();
        p2.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_jButton9ActionPerformed

    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
       Teoria_Unidad2 p1 = new Teoria_Unidad2();
        p1.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_jButton10ActionPerformed

    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        Examen_Unidad2 e2 = new Examen_Unidad2();
        e2.setVisible(true);
        this.setVisible(false);
    ...
    private void CalculadoraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculadoraActionPerformed
        ...
        CalculadoraUnid2 w = new CalculadoraUnid2();
        w.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Unidad_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
