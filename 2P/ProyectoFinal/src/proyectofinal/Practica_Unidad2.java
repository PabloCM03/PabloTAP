...
public class Practica_Unidad2 extends javax.swing.JFrame {

    public Practica_Unidad2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        label1.setText("Práctica Unidad 2");

        jPanel1.setBackground(new java.awt.Color(204, 255, 204));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("1.  Usamos unidades cuadradas como m² o cm² para medir el perímetro");
        ...
        jLabel3.setText("2. Para que dos figuras geométricas tengan la misma área, deben tener las mismas dimensiones");
        ...
        jLabel4.setText("3. El área es  una medida bidimensional");
        ...
        jLabel5.setText("4. Es posible que dos figuras que tienen diferentes formas puedan tener  el mismo perímetro.");
        ...
        jLabel6.setText("5. Usamos  unidades unidimensionales como metros o centímetro para el perímetro.");
        ...
        jLabel7.setText("6. La fórmula (b*h)/2 correspondé a un rectángulo");
        ...
        jLabel8.setText("7. Para hallar el perímetro de un cuadrado es 4*L.");
        ...
        jLabel12.setText("8. Para encontrar el area de un poligono regular es igual a (perímetro*apotema)/2");
        ...
        jLabel13.setText("9. El perímetro de un triángulo varía de acuerdo a su tipo.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Practica_Unidad2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Practica_Unidad2().setVisible(true);
            }
        });
    }
